...
class SpotAPI(Client):
    def __init__(
        ...
        Client.__init__(
            self, api_key, api_secret_key, passphrase, use_server_time, test, first
        )
    ...
    def get_ledger_record(self, currency, after="", before="", limit="", type=""):
        ...
        return self._request_with_params(
            GET, SPOT_LEDGER_RECORD + str(currency) + "/ledger", params, cursor=True
        )
    ...
    def revoke_order(self, instrument_id, order_id="", client_oid=""):
        ...
        if order_id:
            return self._request_with_params(
                POST, SPOT_REVOKE_ORDER + str(order_id), params
            )
        elif client_oid:
            return self._request_with_params(
                POST, SPOT_REVOKE_ORDER + str(client_oid), params
            )
    ...
    def get_order_info(self, instrument_id, order_id="", client_oid=""):
        ...
        if order_id:
            return self._request_with_params(
                GET, SPOT_ORDER_INFO + str(order_id), params
            )
        elif client_oid:
            return self._request_with_params(
                GET, SPOT_ORDER_INFO + str(client_oid), params
            )
    ...
    def get_depth(self, instrument_id, size="", depth=""):
        ...
        if depth:
            params["depth"] = depth
        return self._request_with_params(
            GET, SPOT_DEPTH + str(instrument_id) + "/book", params
        )
    ...
    def get_specific_ticker(self, instrument_id):
        return self._request_without_params(
            GET, SPOT_SPECIFIC_TICKER + str(instrument_id) + "/ticker"
        )
    ...
    def get_deal(self, instrument_id, limit=""):
        ...
        if limit:
            params["limit"] = limit
        return self._request_with_params(
            GET, SPOT_DEAL + str(instrument_id) + "/trades", params
        )
    ...
    def get_kline(self, instrument_id, start="", end="", granularity=""):
        ...
        # from end to start
        return self._request_with_params(
            GET, SPOT_KLINE + str(instrument_id) + "/candles", params
        )
